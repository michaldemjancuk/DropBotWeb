...
include("config/Classes/dbot_ImgGen.php");
include("config/Classes/authenticator.php");

$auth = new Authenticator();
$users = new Users();
$drops = new Dbot_ImgGen();

$auth->Required_Admin();
$dropsData = $drops->GetAllDrops();
                  ...
                  <div class="tab-pane fade active show" id="profile-post">
                     ...
                     <ul class="timeline">
                        <li>
                           <!-- end timeline-icon -->
                           <!-- begin timeline-body -->
                           <div class="timeline-body bg-secondary">
                              <form method="post" action="actions/dbot_generateNewDrops.php">
                                 <div class="timeline-header text-warning">
                                    <i><b>
                                       Generate new drops automatically
                                    </b></i>
                                 </div>
                                 <div class="timeline-content">

                                    <select class="form-select" name="template" aria-label="User upload selection" required>
                                      <option value="">Select template which is supposed to be used</option>
                                      <option value="4by2_Basic" selected>Basic 4x2 Template</option>
                                    </select>
                                      ...
                                      <p>
                                         <div class="input-group">
                                            ...
                                            <datalist id="datalistOptions">
                                              ...
                                              <option value="26">Paid drop less more 3% (Malý)</option>
                                              <option value="29">Just admin drop</option>
                                            </datalist>
                                            <button class="btn btn-primary" type="submit" id="uploadDropImageTxt">Generate</button>
                                        </div>
                                      </p>
                                   </div>
